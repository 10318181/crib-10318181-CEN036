...
while True: #Loop se mantém até que o usuário insira um valor válido de a
    a = int(input("Insira um número positivo menor que 1000: "))
    if isinstance(a, int) and a>0 and a<1000: #primeira condicional determina se o valor é valido
        break
...
while True: #Loop se mantém até que o usuário insira um valor válido de b
    b = int(input("Insira um número positivo menor que 1000: "))
    if isinstance(b, int) and b>0 and b<1000:
        break
    else:
        print("Número ou caracter inserido é inválido")
#Esse segundo while funciona da mesma forma que o primeiro, para o primeiro valor
